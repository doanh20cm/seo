...
if ( ! function_exists( 'cocco_mikado_get_hide_dep_for_header_vertical_menu_options' ) ) {
	function cocco_mikado_get_hide_dep_for_header_vertical_menu_options() {
		$hide_dep_options = apply_filters( 'cocco_mikado_filter_header_vertical_menu_hide_global_option', $hide_dep_options = array() );
		
		return $hide_dep_options;
	}
}

if ( ! function_exists( 'cocco_mikado_header_vertical_navigation_options_map' ) ) {
	function cocco_mikado_header_vertical_navigation_options_map() {
		$hide_dep_options = cocco_mikado_get_hide_dep_for_header_vertical_menu_options();
		
		$panel_vertical_main_menu = cocco_mikado_add_admin_panel(
			array(
				'title'           => esc_html__( 'Vertical Main Menu', 'cocco' ),
		...
		$drop_down_group = cocco_mikado_add_admin_group(
			array(
				...
				'description' => esc_html__( 'Set a style for dropdown menu', 'cocco' )
			)
		);
		
		$vertical_drop_down_row1 = cocco_mikado_add_admin_row(
			array(
		...
		cocco_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Top Margin', 'cocco' ),
				'args'          => array(
					'suffix' => 'px'
				),
		...
		cocco_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Bottom Margin', 'cocco' ),
				'args'          => array(
					'suffix' => 'px'
				),
				'parent'        => $vertical_drop_down_row1
		...
		cocco_mikado_add_admin_field(
			array(
				...
				'default_value' => 'below',
				'label'         => esc_html__( 'Submenu Opening', 'cocco' ),
				'options'		=> array(
					'below' => esc_html__('Below', 'cocco'),
					'side' => esc_html__('On Side', 'cocco'),
				),
				'parent'        => $panel_vertical_main_menu
			)
		);

		$group_vertical_first_level = cocco_mikado_add_admin_group(
			array(
				'name'        => 'group_vertical_first_level',
				'title'       => esc_html__( '1st level', 'cocco' ),
				'description' => esc_html__( 'Define styles for 1st level menu', 'cocco' ),
				'parent'      => $panel_vertical_main_menu
			)
		);
		
		$row_vertical_first_level_1 = cocco_mikado_add_admin_row(
			array(
		...
		$row_vertical_first_level_2 = cocco_mikado_add_admin_row(
			array(
		...
		$row_vertical_first_level_3 = cocco_mikado_add_admin_row(
			array(
		...
		$group_vertical_second_level = cocco_mikado_add_admin_group(
			array(
				'name'        => 'group_vertical_second_level',
				'title'       => esc_html__( '2nd level', 'cocco' ),
				'description' => esc_html__( 'Define styles for 2nd level menu', 'cocco' ),
				'parent'      => $panel_vertical_main_menu
			)
		);
		
		$row_vertical_second_level_1 = cocco_mikado_add_admin_row(
			array(
		...
		$row_vertical_second_level_2 = cocco_mikado_add_admin_row(
			array(
		...
		$row_vertical_second_level_3 = cocco_mikado_add_admin_row(
			array(
		...
		$group_vertical_third_level = cocco_mikado_add_admin_group(
			array(
				'name'        => 'group_vertical_third_level',
				'title'       => esc_html__( '3rd level', 'cocco' ),
				'description' => esc_html__( 'Define styles for 3rd level menu', 'cocco' ),
				'parent'      => $panel_vertical_main_menu
			)
		);
		
		$row_vertical_third_level_1 = cocco_mikado_add_admin_row(
			array(
		...
		$row_vertical_third_level_2 = cocco_mikado_add_admin_row(
			array(
		...
		$row_vertical_third_level_3 = cocco_mikado_add_admin_row(
			array(
	...
	add_action( 'cocco_mikado_action_additional_header_main_navigation_options_map', 'cocco_mikado_header_vertical_navigation_options_map', 10, 1 );
}