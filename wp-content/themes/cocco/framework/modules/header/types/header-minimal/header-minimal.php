...
class HeaderMinimal extends HeaderType {
	...
	public function loadTemplate( $parameters = array() ) {
		...
		$parameters['menu_area_in_grid'] = cocco_mikado_get_meta_field_intersect( 'menu_area_in_grid', $id ) == 'yes' ? true : false;
		$parameters['fullscreen_menu_icon_class'] = cocco_mikado_get_fullscreen_menu_icon_class();
		
		$parameters = apply_filters( 'cocco_mikado_filter_header_minimal_parameters', $parameters );
