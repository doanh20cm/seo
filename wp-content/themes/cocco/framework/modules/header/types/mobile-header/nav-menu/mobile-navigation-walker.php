...
if (!class_exists('CoccoMikadoMobileNavigationWalker')) {
	class CoccoMikadoMobileNavigationWalker extends Walker_Nav_Menu {
		...
		function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
			...
			if($item->hide == ""){
				...
				if($args->has_children) {
					$item_output .= '<span class="mobile_arrow"><i class="mkdf-sub-arrow fas fa-angle-right"></i><i class="fas fa-angle-down"></i></span>';
				}
			}
