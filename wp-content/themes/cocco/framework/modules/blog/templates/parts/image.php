...
$blog_list_image_id  = ! empty( $image_meta ) && cocco_mikado_blog_item_has_link() ? cocco_mikado_get_attachment_id_from_url( $image_meta ) : '';
?>

<?php if ( $has_featured ) { ?>
	<div class="mkdf-post-image">
		<?php if ( cocco_mikado_blog_item_has_link() ) { ?>
		...
		<?php } ?>
		<?php do_action('cocco_mikado_action_blog_inside_image_tag')?>
	</div>
<?php } ?>