	    ...
	    <div class="mkdf-self-hosted-video-holder">
		    <div class="mkdf-video-wrap">
			    <video class="mkdf-self-hosted-video" poster="<?php echo esc_url( $videoimage ); ?>" preload="auto">
				    ...
				    <object width="320" height="240" type="application/x-shockwave-flash" data="<?php echo esc_attr( $flashmedia ); ?>">
					    <param name="movie" value="<?php echo esc_attr( $flashmedia ); ?>"/>
					    <param name="flashvars" value="controls=true&file=<?php echo esc_url( $videolink ); ?>" />
					    <img itemprop="image" src="<?php echo esc_attr( $videoimage ); ?>" width="1920" height="800" title="No video playback capabilities" alt="Video Thumb"/>
				    </object>
			    </video>
		    </div>
	    </div>
