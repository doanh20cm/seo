<?php
namespace CoccoCore\CPT\Shortcodes\BlogList;
...
class BlogList implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		vc_map(
			array(
				'name'                      => esc_html__( 'Mikado Blog List', 'cocco' ),
				'base'                      => $this->base,
				...
				'params'                    => array(
					array(
						...
						'value'       => array(
							...
							esc_html__( 'Boxed', 'cocco' )    => 'boxed',
							esc_html__( 'Masonry', 'cocco' )  => 'masonry',
							esc_html__( 'Simple', 'cocco' )   => 'simple',
							esc_html__( 'Minimal', 'cocco' )  => 'minimal'
						),
						'save_always' => true
					),
					array(
						...
						'heading'    => esc_html__( 'Number of Posts', 'cocco' )
					),
					array(
						'type'       => 'dropdown',
					...
					array(
						...
						'value'       => array_flip( cocco_mikado_get_query_order_by_array() ),
						'save_always' => true
					),
					array(
						'type'        => 'dropdown',
					...
					array(
						'type'        => 'autocomplete',
						'param_name'  => 'category',
						'heading'     => esc_html__( 'Category', 'cocco' ),
						'description' => esc_html__( 'Enter one category slug (leave empty for showing all categories)', 'cocco' )
					),
					array(
						'type'       => 'dropdown',
						'param_name' => 'image_size',
						'heading'    => esc_html__( 'Image Size', 'cocco' ),
						'value'      => array(
							...
							esc_html__( 'Thumbnail', 'cocco' ) => 'thumbnail',
					...
					array(
						...
						'group'      => esc_html__( 'Post Info', 'cocco' )
					),
					array(
						'type'       => 'dropdown',
					...
					array(
						...
						'heading'     => esc_html__( 'Text Length', 'cocco' ),
						'description' => esc_html__( 'Number of characters', 'cocco' ),
					...
					array(
						...
						'heading'    => esc_html__( 'Enable Post Info Image', 'cocco' ),
					...
					array(
						...
						'heading'    => esc_html__( 'Enable Image Zoom', 'cocco' ),
					...
					array(
						...
						'heading'    => esc_html__( 'Enable Image Shader', 'cocco' ),
						'value'      => array_flip( cocco_mikado_get_yes_no_select_array( false, false ) ),
						'dependency' => Array( 'element' => 'post_info_image', 'value'   => array( 'yes' ) ),
						'group'      => esc_html__( 'Post Info', 'cocco' )
					),
					array(
						...
						'heading'    => esc_html__( 'Enable Post Info Section', 'cocco' ),
						'value'      => array_flip( cocco_mikado_get_yes_no_select_array( false, true ) ),
						'dependency' => Array( 'element' => 'type', 'value'   => array( 'standard', 'boxed', 'masonry' ) ),
						'group'      => esc_html__( 'Post Info', 'cocco' )
					),
					array(
						...
						'heading'    => esc_html__( 'Enable Post Info Author', 'cocco' ),
						'value'      => array_flip( cocco_mikado_get_yes_no_select_array( false, true ) ),
                    ...
                    array(
                        ...
                        'heading'    => esc_html__( 'Enable Read More Button', 'cocco' ),
					...
					array(
						...
						'heading'    => esc_html__( 'Date Position', 'cocco' ),
						'value'      => array(
							esc_html__('Default', 'cocco') => '',
							esc_html__('On Image','cocco') => 'on-image',
						),
						'dependency' => Array( 'element' => 'type', 'value' => array( 'standard', 'masonry' ) ),
						'description'=> esc_html__('This option will take effect only if date is enabled','cocco'),
						'group'      => esc_html__( 'Post Info', 'cocco' )
					),
					array(
						'type'       => 'dropdown',
						'param_name' => 'post_info_date',
						'heading'    => esc_html__( 'Enable Post Info Date', 'cocco' ),
						'value'      => array_flip( cocco_mikado_get_yes_no_select_array( false, true ) ),
						'dependency' => Array( 'element' => 'post_info_section', 'value' => array( 'yes' ) ),
						'group'      => esc_html__( 'Post Info', 'cocco' )
					),
					array(
						...
						'heading'    => esc_html__( 'Enable Post Info Category', 'cocco' ),
						'value'      => array_flip( cocco_mikado_get_yes_no_select_array( false, true ) ),
						'dependency' => Array( 'element' => 'post_info_section', 'value' => array( 'yes' ) ),
						'group'      => esc_html__( 'Post Info', 'cocco' )
					),
					array(
						...
						'heading'    => esc_html__( 'Enable Post Info Comments', 'cocco' ),
					...
					array(
						...
						'heading'    => esc_html__( 'Enable Post Info Like', 'cocco' ),
						'value'      => array_flip( cocco_mikado_get_yes_no_select_array( false ) ),
						'dependency' => Array( 'element' => 'post_info_section', 'value' => array( 'yes' ) ),
						'group'      => esc_html__( 'Post Info', 'cocco' )
					),
					array(
						...
						'heading'    => esc_html__( 'Enable Post Info Share', 'cocco' ),
						'value'      => array_flip( cocco_mikado_get_yes_no_select_array( false ) ),
						'dependency' => Array( 'element' => 'post_info_section', 'value' => array( 'yes' ) ),
						'group'      => esc_html__( 'Post Info', 'cocco' )
					),
					array(
						...
						'heading'    => esc_html__( 'Pagination Type', 'cocco' ),
						'value'      => array(
							esc_html__( 'None', 'cocco' )            => 'no-pagination',
							esc_html__( 'Standard', 'cocco' )        => 'standard-shortcodes',
							esc_html__( 'Load More', 'cocco' )       => 'load-more',
							esc_html__( 'Infinite Scroll', 'cocco' ) => 'infinite-scroll'
						),
						'group'      => esc_html__( 'Additional Features', 'cocco' )
					)
				)
			)
		);
	...
	public function render( $atts, $content = null ) {
		...
		cocco_mikado_get_module_template_part( 'shortcodes/blog-list/holder', 'blog', $params['type'], $params );
