<?php
namespace CoccoCore\CPT\Shortcodes\BlogSlider;
...
class BlogSlider implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		vc_map(
			array(
				'name'                      => esc_html__( 'Mikado Blog Slider', 'cocco' ),
				'base'                      => $this->base,
				...
				'params'                    => array(
					array(
						...
						'value'       => array(
							esc_html__( 'Slider', 'cocco' )            => 'slider',
							esc_html__( 'Carousel', 'cocco' )          => 'carousel',
							esc_html__( 'Carousel Centered', 'cocco' ) => 'carousel-centered'
						),
						'save_always' => true
					),
					array(
	...
	public function render( $atts, $content = null ) {
		...
		cocco_mikado_get_module_template_part( 'shortcodes/blog-slider/holder', 'blog', '', $params );
