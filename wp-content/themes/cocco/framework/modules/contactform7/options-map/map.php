...
if ( ! function_exists('cocco_mikado_contact_form_7_options_map') ) {

	function cocco_mikado_contact_form_7_options_map() {
		
		cocco_mikado_add_admin_page(
			array(
				'slug'  => '_contact_form7_page',
				'title' => esc_html__( 'Contact Form 7', 'cocco' ),
				'icon'  => 'fa fa-envelope-o'
			)
		);
		
		$panel_contact_form_style_1 = cocco_mikado_add_admin_panel(
			array(
				'page'  => '_contact_form7_page',
				'name'  => 'panel_contact_form_style_1',
				'title' => esc_html__( 'Custom Style 1', 'cocco' )
			)
		);
		
		//Text Typography
		
		$typography_text_group = cocco_mikado_add_admin_group(
			array(
				'name'        => 'typography_text_group',
				'title'       => esc_html__( 'Form Text Typography', 'cocco' ),
				'description' => esc_html__( 'Setup typography for form elements text', 'cocco' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$typography_text_row1 = cocco_mikado_add_admin_row(
			array(
		...
		cocco_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Focus Text Color', 'cocco' ),
			)
		);
		...
		$typography_text_row2 = cocco_mikado_add_admin_row(
			array(
		...
		$typography_text_row3 = cocco_mikado_add_admin_row(
			array(
		...
		$typography_label_group = cocco_mikado_add_admin_group(
			array(
				'name'        => 'typography_label_group',
				'title'       => esc_html__( 'Form Label Typography', 'cocco' ),
				'description' => esc_html__( 'Setup typography for form elements label', 'cocco' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$typography_label_row1 = cocco_mikado_add_admin_row(
			array(
		...
		$typography_label_row2 = cocco_mikado_add_admin_row(
			array(
		...
		$background_border_group = cocco_mikado_add_admin_group(
			array(
				'name'        => 'background_border_group',
				'title'       => esc_html__( 'Form Elements Background and Border', 'cocco' ),
				'description' => esc_html__( 'Setup form elements background and border style', 'cocco' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$background_border_row1 = cocco_mikado_add_admin_row(
			array(
		...
		cocco_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Focus Background Color', 'cocco' )
			)
		);
		...
		cocco_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Focus Background Transparency', 'cocco' )
			)
		);
		
		$background_border_row2 = cocco_mikado_add_admin_row(
			array(
		...
		cocco_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Border Transparency', 'cocco' ),
			)
		);
		...
		cocco_mikado_add_admin_field(
			array(
				...
				'label'  => esc_html__( 'Focus Border Color', 'cocco' )
			)
		);
		...
		cocco_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Focus Border Transparency', 'cocco' )
			)
		);
		
		$background_border_row3 = cocco_mikado_add_admin_row(
			array(
		...
		cocco_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Border Width', 'cocco' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		cocco_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Border Radius', 'cocco' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		$padding_group = cocco_mikado_add_admin_group(
			array(
				'name'        => 'padding_group',
				'title'       => esc_html__( 'Elements Padding', 'cocco' ),
				'description' => 'Setup form elements padding',
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$padding_row = cocco_mikado_add_admin_row(
			array(
				'name'   => 'padding_row',
		...
		cocco_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Padding Top', 'cocco' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		cocco_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Padding Right', 'cocco' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		cocco_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Padding Bottom', 'cocco' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		cocco_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Padding Left', 'cocco' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		$margin_group = cocco_mikado_add_admin_group(
			array(
				'name'        => 'margin_group',
				'title'       => esc_html__( 'Elements Margin', 'cocco' ),
				'description' => esc_html__( 'Setup form elements margin', 'cocco' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$margin_row = cocco_mikado_add_admin_row(
			array(
				'name'   => 'margin_row',
				'parent' => $margin_group
			)
		...
		cocco_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Textarea Height', 'cocco' ),
				'description'   => esc_html__( 'Enter height for textarea form element', 'cocco' ),
				'args'          => array(
					'col_width' => '3',
					'suffix'    => 'px'
				)
		...
		$button_typography_group = cocco_mikado_add_admin_group(
			array(
				'name'        => 'button_typography_group',
				'title'       => esc_html__( 'Button Typography', 'cocco' ),
				'description' => esc_html__( 'Setup button text typography', 'cocco' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$button_typography_row1 = cocco_mikado_add_admin_row(
			array(
		...
		$button_typography_row2 = cocco_mikado_add_admin_row(
			array(
		...
		$button_background_border_group = cocco_mikado_add_admin_group(
			array(
				'name'        => 'button_background_border_group',
				'title'       => esc_html__( 'Button Background and Border', 'cocco' ),
				'description' => esc_html__( 'Setup button background and border style', 'cocco' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$button_background_border_row1 = cocco_mikado_add_admin_row(
			array(
		...
		cocco_mikado_add_admin_field(
			array(
				...
				'label'  => esc_html__( 'Background Hover Color', 'cocco' )
			)
		);
		...
		cocco_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Background Hover Transparency', 'cocco' )
			)
		);
		
		$button_background_border_row2 = cocco_mikado_add_admin_row(
			array(
		...
		cocco_mikado_add_admin_field(
			array(
				...
				'label'  => esc_html__( 'Border Hover Color', 'cocco' )
			)
		);
		...
		cocco_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Border Hover Transparency', 'cocco' )
			)
		);
		
		$button_background_border_row3 = cocco_mikado_add_admin_row(
			array(
		...
		cocco_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Button Height', 'cocco' ),
				'args'          => array(
					'col_width' => '3',
					'suffix'    => 'px'
				)
		...
		cocco_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Button Left/Right Padding', 'cocco' ),
				'args'          => array(
					'col_width' => '3',
					'suffix'    => 'px'
				)
		...
		$panel_contact_form_style_2 = cocco_mikado_add_admin_panel(array(
			'page'	=> '_contact_form7_page',
			'name'	=> 'panel_contact_form_style_2',
			'title'	=> esc_html__('Custom Style 2', 'cocco')
		));

		//Text Typography

		$typography_text_group = cocco_mikado_add_admin_group(array(
			'name'			=> 'typography_text_group',
			'title'			=> esc_html__('Form Text Typography', 'cocco'),
			'description'	=> esc_html__('Setup typography for form elements text', 'cocco'),
		...
		$typography_text_row1 = cocco_mikado_add_admin_row(array(
			'name'		=> 'typography_text_row1',
			'parent'	=> $typography_text_group
		));
		...
		$typography_text_row2 = cocco_mikado_add_admin_row(array(
			'name'		=> 'typography_text_row2',
			'next'		=> true,
			'parent'	=> $typography_text_group
		));
		...
		$typography_text_row3 = cocco_mikado_add_admin_row(array(
			'name'		=> 'typography_text_row3',
			'next'		=> true,
			'parent'	=> $typography_text_group
		));
		...
		$typography_label_group = cocco_mikado_add_admin_group(array(
			'name'			=> 'typography_label_group',
			'title'			=> esc_html__('Form Label Typography', 'cocco'),
			'description'	=> esc_html__('Setup typography for form elements label', 'cocco'),
			'parent'		=> $panel_contact_form_style_2
		...
		$typography_label_row1 = cocco_mikado_add_admin_row(array(
			'name'		=> 'typography_label_row1',
			'parent'	=> $typography_label_group
		));
		...
		$typography_label_row2 = cocco_mikado_add_admin_row(array(
			'name'		=> 'typography_label_row2',
			'next'		=> true,
			'parent'	=> $typography_label_group
		));
		...
		$background_border_group = cocco_mikado_add_admin_group(array(
			'name'			=> 'background_border_group',
			'title'			=> esc_html__('Form Elements Background and Border', 'cocco'),
			'description'	=> esc_html__('Setup form elements background and border style', 'cocco'),
			'parent'		=> $panel_contact_form_style_2
		...
		$background_border_row1 = cocco_mikado_add_admin_row(array(
			'name'		=> 'background_border_row1',
			'parent'	=> $background_border_group
		));
		...
		$background_border_row2 = cocco_mikado_add_admin_row(array(
			'name'		=> 'background_border_row2',
			'next'		=> true,
			'parent'	=> $background_border_group
		));
		...
		$background_border_row3 = cocco_mikado_add_admin_row(array(
			'name'		=> 'background_border_row3',
			'next'		=> true,
			'parent'	=> $background_border_group
		));
		...
		$padding_group = cocco_mikado_add_admin_group(array(
			'name'			=> 'padding_group',
			'title'			=> esc_html__('Elements Padding', 'cocco'),
			'description'	=> 'Setup form elements padding',
			'parent'		=> $panel_contact_form_style_2
		...
		$padding_row = cocco_mikado_add_admin_row(array(
			'name'		=> 'padding_row',
			'parent'	=> $padding_group
		));
		...
		$margin_group = cocco_mikado_add_admin_group(array(
			'name'			=> 'margin_group',
			'title'			=> esc_html__('Elements Margin', 'cocco'),
			'description'	=> esc_html__('Setup form elements margin', 'cocco'),
			'parent'		=> $panel_contact_form_style_2
		...
		$margin_row = cocco_mikado_add_admin_row(array(
			'name'		=> 'margin_row',
			'parent'	=> $margin_group
		));
		...
		$button_typography_group = cocco_mikado_add_admin_group(array(
			'name'			=> 'button_typography_group',
			'title'			=> esc_html__('Button Typography', 'cocco'),
			'description'	=> esc_html__('Setup button text typography', 'cocco'),
			'parent'		=> $panel_contact_form_style_2
		...
		$button_typography_row1 = cocco_mikado_add_admin_row(array(
			'name'		=> 'button_typography_row1',
			'parent'	=> $button_typography_group
		));
		...
		$button_typography_row2 = cocco_mikado_add_admin_row(array(
			'name'		=> 'button_typography_row2',
			'next'		=> true,
			'parent'	=> $button_typography_group
		));
		...
		$button_background_border_group = cocco_mikado_add_admin_group(array(
			'name'			=> 'button_background_border_group',
			'title'			=> esc_html__('Button Background and Border', 'cocco'),
			'description'	=> esc_html__('Setup button background and border style', 'cocco'),
			'parent'		=> $panel_contact_form_style_2
		...
		$button_background_border_row1 = cocco_mikado_add_admin_row(array(
			'name'		=> 'button_background_border_row1',
			'parent'	=> $button_background_border_group
		));
		...
		$button_background_border_row2 = cocco_mikado_add_admin_row(array(
			'name'		=> 'button_background_border_row2',
			'next'		=> true,
			'parent'	=> $button_background_border_group
		));
		...
		$button_background_border_row3 = cocco_mikado_add_admin_row(array(
			'name'		=> 'button_background_border_row3',
			'next'		=> true,
			'parent'	=> $button_background_border_group
		));
        ...
        $panel_contact_form_style_3 = cocco_mikado_add_admin_panel(array(
            'page'	=> '_contact_form7_page',
            'name'	=> 'panel_contact_form_style_3',
            'title'	=> esc_html__('Custom Style 3', 'cocco')
        ));
        ...
        $typography_label_row3 = cocco_mikado_add_admin_row(array(
        ...
        $button_typography_row3 = cocco_mikado_add_admin_row(array(
	...
	add_action( 'cocco_mikado_action_options_map', 'cocco_mikado_contact_form_7_options_map', 20);
}