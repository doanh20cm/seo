...
if ( class_exists( 'CoccoMikadoWidget' ) ) {
	class CoccoMikadoIconWidget extends CoccoMikadoWidget {
		public function __construct() {
			parent::__construct(
				'mkdf_icon_widget',
				esc_html__( 'Mikado Icon Widget', 'cocco' ),
				array( 'description' => esc_html__( 'Add icons to widget areas', 'cocco' ) )
			);
		...
		protected function setParams() {
			$this->params = array_merge(
				cocco_mikado_icon_collections()->getIconWidgetParamsArray(),
				array(
					array(
						'type'  => 'textfield',
						'name'  => 'icon_text',
						'title' => esc_html__( 'Icon Text', 'cocco' )
					),
					array(
						'type'  => 'textfield',
						'name'  => 'link',
		...
		public function widget( $args, $instance ) {
			...
			$data   = array();
			$data[] = ! empty( $instance['icon_hover_color'] ) ? cocco_mikado_get_inline_attr( $instance['icon_hover_color'], 'data-hover-color' ) : '';
			$data   = implode( ' ', $data );
			...
			if ( ! empty( $instance['icon_size'] ) ) {
				$holder_styles[] = 'font-size: ' . cocco_mikado_filter_px( $instance['icon_size'] ) . 'px';
			}
            ...
            <a <?php cocco_mikado_class_attribute( $holder_classes ); ?> <?php echo wp_kses_post( $data ); ?>
                    href="<?php echo esc_url( $link ); ?>"
                    target="<?php echo esc_attr( $target ); ?>" <?php echo cocco_mikado_get_inline_style( $holder_styles ); ?>>
