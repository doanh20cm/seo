...
if ( ! function_exists( 'cocco_mikado_error_404_options_map' ) ) {
	function cocco_mikado_error_404_options_map() {

		cocco_mikado_add_admin_page(
			array(
				'slug'  => '__404_error_page',
				'title' => esc_html__( '404 Error Page', 'cocco' ),
				'icon'  => 'fa fa-exclamation-triangle'
			)
		);

		$panel_404_header = cocco_mikado_add_admin_panel(
			array(
		...
		cocco_mikado_add_admin_field(
			array(
				...
				'description' => esc_html__( 'Choose a border bottom color for header area', 'cocco' )
			)
		);
		...
		cocco_mikado_add_admin_field(
			array(
				...
				'description'   => esc_html__( 'Choose a header style to make header elements (logo, main menu, side menu button) in that predefined style', 'cocco' ),
				'options'       => array(
		...
		$panel_404_options = cocco_mikado_add_admin_panel(
			array(
				'page'  => '__404_error_page',
				'name'  => 'panel_404_options',
				'title' => esc_html__( '404 Page Options', 'cocco' )
			)
		);
		...
		cocco_mikado_add_admin_field(
			array(
				...
				'description' => esc_html__( 'Choose a background image for 404 page', 'cocco' )
			)
		);
		...
		cocco_mikado_add_admin_field(
			array(
				...
				'description' => esc_html__( 'Choose a pattern image for 404 page', 'cocco' )
			)
		);
		...
		cocco_mikado_add_admin_field(
			array(
				...
				'label'       => esc_html__( 'Title Image', 'cocco' ),
				'description' => esc_html__( 'Choose a background image for displaying above 404 page Title', 'cocco' )
			)
		);
		...
		cocco_mikado_add_admin_field(
			array(
				...
				'description'   => esc_html__( 'Enter title for 404 page. Default label is "404".', 'cocco' )
			)
		);
		...
		$first_level_group = cocco_mikado_add_admin_group(
			array(
				...
				'title'       => esc_html__( 'Title Style', 'cocco' ),
				'description' => esc_html__( 'Define styles for 404 page title', 'cocco' )
			)
		);
		...
		$first_level_group_responsive = cocco_mikado_add_admin_group(
			array(
				'parent'      => $panel_404_options,
				'name'        => 'first_level_group_responsive',
				'title'       => esc_html__( 'Title Style Responsive', 'cocco' ),
				'description' => esc_html__( 'Define responsive styles for 404 page title (under 680px)', 'cocco' )
			)
		);
		...
		cocco_mikado_add_admin_field(
			array(
				...
				'description'   => esc_html__( 'Enter subtitle for 404 page. Default label is "PAGE NOT FOUND".', 'cocco' )
			)
		);
		...
		$second_level_group = cocco_mikado_add_admin_group(
			array(
				...
				'title'       => esc_html__( 'Subtitle Style', 'cocco' ),
				'description' => esc_html__( 'Define styles for 404 page subtitle', 'cocco' )
			)
		);
		...
		$second_level_group_responsive = cocco_mikado_add_admin_group(
			array(
				'parent'      => $panel_404_options,
				'name'        => 'second_level_group_responsive',
				'title'       => esc_html__( 'Subtitle Style Responsive', 'cocco' ),
				'description' => esc_html__( 'Define responsive styles for 404 page subtitle (under 680px)', 'cocco' )
			)
		);
		...
		cocco_mikado_add_admin_field(
			array(
				...
				'name'          => '404_text',
				'default_value' => '',
				'label'         => esc_html__( 'Text', 'cocco' ),
				'description'   => esc_html__( 'Enter text for 404 page.', 'cocco' )
			)
		);
		...
		$third_level_group = cocco_mikado_add_admin_group(
			array(
				...
				'title'       => esc_html__( 'Text Style', 'cocco' ),
				'description' => esc_html__( 'Define styles for 404 page text', 'cocco' )
			)
		);
		...
		$third_level_group_responsive = cocco_mikado_add_admin_group(
			array(
				'parent'      => $panel_404_options,
				'name'        => 'third_level_group_responsive',
				'title'       => esc_html__( 'Text Style Responsive', 'cocco' ),
				'description' => esc_html__( 'Define responsive styles for 404 page text (under 680px)', 'cocco' )
			)
		);
		...
		cocco_mikado_add_admin_field(
			array(
				...
				'label'       => esc_html__( 'Back to Home Button Label', 'cocco' ),
				'description' => esc_html__( 'Enter label for "Back to home" button', 'cocco' )
			)
		);
		...
		cocco_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Button Skin', 'cocco' ),
				'description'   => esc_html__( 'Choose a style to make Back to Home button in that predefined style', 'cocco' ),
				'options'       => array(
					''            => esc_html__( 'Default', 'cocco' ),
					'light-style' => esc_html__( 'Light', 'cocco' )
				)
			)
		);
	}

	add_action( 'cocco_mikado_action_options_map', 'cocco_mikado_error_404_options_map', 19 );
}