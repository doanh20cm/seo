...
if($display_button === 'yes') {
	...
	<div class="mkdf-<?php echo esc_attr($class_name); ?>-add-to-cart <?php echo esc_attr($buttonSkinClass); ?>">
		<?php echo apply_filters( 'cocco_mikado_filter_product_list_add_to_cart_link',
			sprintf( '<a rel="nofollow" href="%s" data-quantity="%s" data-product_id="%s" data-product_sku="%s" class="%s mkdf-pl-btn mkdf-btn mkdf-btn-solid">%s</a>',
