...
if ( ! function_exists( 'cocco_mikado_add_font_elegant_icon_pack' ) ) {
	function cocco_mikado_add_font_elegant_icon_pack( $iconCollections ) {
		$iconCollections['font_elegant'] = new CoccoMikadoIconsFontElegant( 'Font Elegant', 'fe_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'cocco_mikado_filter_add_icon_pack_into_collection', 'cocco_mikado_add_font_elegant_icon_pack' );
}

if ( ! function_exists( 'cocco_mikado_add_font_elegant_icon_pack_option' ) ) {
	function cocco_mikado_add_font_elegant_icon_pack_option( $options ) {
		$options['font_elegant'] = esc_html__( 'Font Elegant', 'cocco' );
		
		return $options;
	}
	
	add_filter( 'cocco_mikado_filter_add_icon_pack_into_options', 'cocco_mikado_add_font_elegant_icon_pack_option' );
	add_filter( 'cocco_mikado_filter_add_icon_pack_into_social_options', 'cocco_mikado_add_font_elegant_icon_pack_option' );
}

class CoccoMikadoIconsFontElegant implements iCoccoMikadoIconCollection {
	public $icons;
	public $title;
	public $param;
	public $styleUrl;
	...
	function __construct($title_label = "", $param = "") {
		...
		$this->styleUrl = MIKADO_FRAMEWORK_ICONS_ROOT . '/elegant-icons/style.min.css';
	}
	...
	public function getDropdownCartIcon() {
		...
		return $this->render('icon_bag_alt');
	}
