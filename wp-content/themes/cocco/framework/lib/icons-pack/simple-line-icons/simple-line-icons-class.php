...
if ( ! function_exists( 'cocco_mikado_add_simple_line_icon_pack' ) ) {
	function cocco_mikado_add_simple_line_icon_pack( $iconCollections ) {
		$iconCollections['simple_line_icons'] = new CoccoMikadoSimpleLineIcons( 'Simple Line Icons', 'simple_line_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'cocco_mikado_filter_add_icon_pack_into_collection', 'cocco_mikado_add_simple_line_icon_pack' );
}

if ( ! function_exists( 'cocco_mikado_add_simple_line_icon_pack_option' ) ) {
	function cocco_mikado_add_simple_line_icon_pack_option( $options ) {
		$options['simple_line_icons'] = esc_html__( 'Simple Line Icons', 'cocco' );
		
		return $options;
	}
	
	add_filter( 'cocco_mikado_filter_add_icon_pack_into_options', 'cocco_mikado_add_simple_line_icon_pack_option' );
	add_filter( 'cocco_mikado_filter_add_icon_pack_into_social_options', 'cocco_mikado_add_simple_line_icon_pack_option' );
}

class CoccoMikadoSimpleLineIcons implements iCoccoMikadoIconCollection {
    public $icons;
    public $title;
    public $param;
    public $styleUrl;
    ...
    public function __construct($title_label = "", $param = "") {
        ...
        $this->styleUrl = MIKADO_FRAMEWORK_ICONS_ROOT . '/simple-line-icons/simple-line-icons.css';
    }
    ...
    public function setSocialIconsArray() {
        $this->socialIcons = array(
            ''                        => '',
            'icon-social-behance'     => esc_html__('Behance', 'cocco'),
            'icon-social-dribbble'    => esc_html__('Dribbble', 'cocco'),
            'icon-social-dropbox'     => esc_html__('Dropbox', 'cocco'),
            'icon-social-facebook'    => esc_html__('Facebook', 'cocco'),
            'icon-social-foursquare'  => esc_html__('Foursquare', 'cocco'),
            'icon-social-github'      => esc_html__('Github', 'cocco'),
            'icon-social-gplus'       => esc_html__('Google Plus', 'cocco'),
            'icon-social-instagram'   => esc_html__('Instagram', 'cocco'),
            'icon-social-linkedin'    => esc_html__('LinkedIn', 'cocco'),
            'icon-social-pintarest'   => esc_html__('Pinterest', 'cocco'),
            'icon-social-reddit'      => esc_html__('Reddit', 'cocco'),
            'icon-social-skype'       => esc_html__('Skype', 'cocco'),
            'icon-social-soundcloud'  => esc_html__('Soundcloud', 'cocco'),
            'icon-social-stumbleupon' => esc_html__('Stumbleupon', 'cocco'),
            'icon-social-spotify'     => esc_html__('Spotify', 'cocco'),
            'icon-social-tumblr'      => esc_html__('Tumblr', 'cocco'),
            'icon-social-twitter'     => esc_html__('Twitter', 'cocco'),
            'icon-social-youtube'     => esc_html__('Youtube', 'cocco')
        );
    }
