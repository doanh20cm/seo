...
if ( ! function_exists( 'cocco_mikado_add_dripicons_icon_pack' ) ) {
	function cocco_mikado_add_dripicons_icon_pack( $iconCollections ) {
		$iconCollections['dripicons'] = new CoccoMikadoDripicons( 'Dripicons', 'dripicon' );
		
		return $iconCollections;
	}
	
	add_filter( 'cocco_mikado_filter_add_icon_pack_into_collection', 'cocco_mikado_add_dripicons_icon_pack' );
}

if ( ! function_exists( 'cocco_mikado_add_dripicons_icon_pack_option' ) ) {
	function cocco_mikado_add_dripicons_icon_pack_option( $options ) {
		$options['dripicons'] = esc_html__( 'Dripicons', 'cocco' );
		
		return $options;
	}
	
	add_filter( 'cocco_mikado_filter_add_icon_pack_into_options', 'cocco_mikado_add_dripicons_icon_pack_option' );
}

class CoccoMikadoDripicons implements iCoccoMikadoIconCollection {
    public $icons;
    public $title;
    public $param;
    public $styleUrl;
    ...
    public function getBackToTopIcon(){
        return $this->render('dripicons-rocket');
    }
