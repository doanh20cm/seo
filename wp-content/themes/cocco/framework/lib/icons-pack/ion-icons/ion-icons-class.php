...
if ( ! function_exists( 'cocco_mikado_add_ion_icon_pack' ) ) {
	function cocco_mikado_add_ion_icon_pack( $iconCollections ) {
		$iconCollections['ion_icons'] = new CoccoMikadoIonIcons( 'Ion Icons', 'ion_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'cocco_mikado_filter_add_icon_pack_into_collection', 'cocco_mikado_add_ion_icon_pack' );
}

if ( ! function_exists( 'cocco_mikado_add_ion_icon_pack_option' ) ) {
	function cocco_mikado_add_ion_icon_pack_option( $options ) {
		$options['ion_icons'] = esc_html__( 'Ion Icons', 'cocco' );
		
		return $options;
	}
	
	add_filter( 'cocco_mikado_filter_add_icon_pack_into_options', 'cocco_mikado_add_ion_icon_pack_option' );
	add_filter( 'cocco_mikado_filter_add_icon_pack_into_social_options', 'cocco_mikado_add_ion_icon_pack_option' );
}

class CoccoMikadoIonIcons implements iCoccoMikadoIconCollection {
	public $icons;
	public $socialIcons;
    public $title;
	public $param;
	...
	function __construct($title_label = "", $param = "") {
		...
		$this->styleUrl = MIKADO_FRAMEWORK_ICONS_ROOT . '/ion-icons/css/ionicons.min.css';
	}
