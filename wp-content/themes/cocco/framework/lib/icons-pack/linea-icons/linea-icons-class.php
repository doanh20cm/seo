...
if ( ! function_exists( 'cocco_mikado_add_linea_icon_pack' ) ) {
	function cocco_mikado_add_linea_icon_pack( $iconCollections ) {
		$iconCollections['linea_icons'] = new CoccoMikadoLineaIcons( 'Linea Icons', 'linea_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'cocco_mikado_filter_add_icon_pack_into_collection', 'cocco_mikado_add_linea_icon_pack' );
}

if ( ! function_exists( 'cocco_mikado_add_linea_icon_pack_option' ) ) {
	function cocco_mikado_add_linea_icon_pack_option( $options ) {
		$options['linea_icons'] = esc_html__( 'Linea Icons', 'cocco' );
		
		return $options;
	}
	
	add_filter( 'cocco_mikado_filter_add_icon_pack_into_options', 'cocco_mikado_add_linea_icon_pack_option' );
}

class CoccoMikadoLineaIcons implements iCoccoMikadoIconCollection {
	public $icons;
	public $title;
	public $param;
	public $styleUrl;
	...
	public function __construct($title_label = "", $param = "") {
		...
		$this->param = $param;
		$this->setIconsArray();
		$this->styleUrl = MIKADO_FRAMEWORK_ICONS_ROOT . '/linea-icons/style.css';
	}
