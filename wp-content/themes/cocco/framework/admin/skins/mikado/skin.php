...
class MikadoSkin extends CoccoMikadoSkinAbstract {
    /**
     * Skin constructor. Hooks to cocco_mikado_admin_scripts_init and cocco_mikado_enqueue_admin_styles
     */
    public function __construct() {
        $this->skinName = 'mikado';

        //hook to
        add_action('cocco_mikado_action_admin_scripts_init', array($this, 'registerStyles'));
        add_action('cocco_mikado_action_admin_scripts_init', array($this, 'registerScripts'));

        add_action('cocco_mikado_action_enqueue_admin_styles', array($this, 'enqueueStyles'));
        add_action('cocco_mikado_action_enqueue_admin_scripts', array($this, 'enqueueScripts'));

        add_action('cocco_mikado_action_enqueue_meta_box_styles', array($this, 'enqueueStyles'));
        add_action('cocco_mikado_action_enqueue_meta_box_scripts', array($this, 'enqueueScripts'));
	...
	public function registerScripts() {
		...
		foreach ( $this->scripts as $scriptHandle => $script ) {
			cocco_mikado_register_skin_script( $scriptHandle, $script['path'], $script['dependency'] );
		}
	}
    ...
    public function registerStyles() {
        ...
        foreach ($this->styles as $styleHandle => $stylePath) {
            cocco_mikado_register_skin_style($styleHandle, $stylePath);
        }
    }
    ...
    public function renderOptions() {
        ...
        $tab    		= cocco_mikado_get_admin_tab();
        $active_page 	= $cocco_mikado_Framework->mkdOptions->getAdminPageFromSlug($tab);
     ...
     *
     * @see CoccoMikadoSkinAbstract::loadTemplatePart()
     */
     ...
     *
     * @param CoccoMikadoAdminPage $page current page to load
	...
	public function renderBackupOptions() { ?>
		<div class="mkdf-options-page mkdf-page">
			<?php $this->getHeader(cocco_mikado_get_theme_info_item('Name'), cocco_mikado_get_theme_info_item('Version'), false); ?>
			<div class="mkdf-page-content-wrapper">
				<div class="mkdf-page-content">
					<div class="mkdf-page-navigation mkdf-tabs-wrapper vertical left clearfix">
