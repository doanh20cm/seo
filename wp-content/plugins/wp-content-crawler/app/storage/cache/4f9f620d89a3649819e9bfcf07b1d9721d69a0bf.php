<div class="input-group find-replace-in-element-attributes <?php echo e(isset($addon) ? 'addon dev-tools' : ''); ?> <?php echo e(isset($remove) ? 'remove' : ''); ?>"
    ...
    <?php endif; ?>
</div><?php /**PATH C:\xampp\htdocs\webbanhang\wp-content\plugins\wp-content-crawler\app\views/form-items/find-replace-in-element-attributes.blade.php ENDPATH**/ ?>