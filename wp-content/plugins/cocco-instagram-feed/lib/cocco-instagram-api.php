...
include 'cocco-instagram-helper.php';

/**
 * Class CoccoInstagramApi
 */
class CoccoInstagramApi {
	...
	const INSTAGRAM_CODE = 'cocco_instagram_code';
	const INSTAGRAM_USER_ID = 'cocco_instagram_user_id';
	const INSTAGRAM_TOKEN = 'cocco_instagram_access_token';
	const INSTAGRAM_TOKEN_LONG_LIVED = 'cocco_instagram_access_token_long_lived';
	const INSTAGRAM_TOKEN_LONG_LIVED_TIME = 'cocco_instagram_access_token_long_lived_time';

	const FACEBOOK_CODE = 'cocco_facebook_code';
	const FACEBOOK_TOKEN = 'cocco_facebook_access_token';

	const CONNECTION_TYPE = 'cocco_connection_type';
	...
	public function __construct() {
		...
		$this->helper = new CoccoInstagramHelper();
	}

	/**
	 * @return CoccoInstagramApi
	 */
	 ...
	 *
	 * @see CoccoInstagramApi::fetchData()
	 */
	 ...
	 * @return stdClass
	 *
	 * @see CoccoInstagramApi::instagramExchangeCodeForToken()
	 */
