...
/**
 * Class CoccoInstagramHelper
 */
class CoccoInstagramHelper {
	/**
	 * Generates HTML for given image from Instagram feed. Defines cocco_instagram_image_atts filter
	 *
	...
	public function getImageHTML( $image ) {
		...
		$imageAtts = apply_filters( 'cocco_instagram_image_atts',
			array(
