...
if ( ! class_exists( 'MikadoCoreDashboardRestAPI' ) ) {
	 ...
	 */
	class MikadoCoreDashboardRestAPI {
		...
		public function __construct() {
			...
			add_filter( 'mkdf_core_dashboard_filter_js_global_variables', array( $this, 'localize_script' ) );
	...
	MikadoCoreDashboardRestAPI::get_instance();
}