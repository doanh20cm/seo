...
class ElementsHolder implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'      => esc_html__( 'Mikado Elements Holder', 'cocco-core' ),
					'base'      => $this->base,
					...
					'params'    => array(
						...
						array(
							...
							'heading'     => esc_html__( 'Enable Holder Full Height', 'cocco-core' ),
						...
						array(
							...
							'heading'     => esc_html__( 'Columns', 'cocco-core' ),
							'value'       => array(
								esc_html__( '1 Column', 'cocco-core' )  => 'one-column',
								esc_html__( '2 Columns', 'cocco-core' ) => 'two-columns',
								esc_html__( '3 Columns', 'cocco-core' ) => 'three-columns',
								esc_html__( '4 Columns', 'cocco-core' ) => 'four-columns',
								esc_html__( '5 Columns', 'cocco-core' ) => 'five-columns',
								esc_html__( '6 Columns', 'cocco-core' ) => 'six-columns'
							),
							'save_always' => true
						),
						array(
							...
							'heading'    => esc_html__( 'Items Float Left', 'cocco-core' ),
							'value'      => array( 'Make Items Float Left?' => 'yes' )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'switch_to_one_column',
							'heading'     => esc_html__( 'Switch to One Column', 'cocco-core' ),
							'value'       => array(
								...
								esc_html__( 'Never', 'cocco-core' )        => 'never'
							),
							'description' => esc_html__( 'Choose on which stage item will be in one column', 'cocco-core' ),
							'save_always' => true
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'alignment_one_column',
							'heading'     => esc_html__( 'Choose Alignment In Responsive Mode', 'cocco-core' ),
							'value'       => array(
								esc_html__( 'Default', 'cocco-core' ) => '',
							...
							'description' => esc_html__( 'Alignment When Items are in One Column', 'cocco-core' ),
							'save_always' => true
						)
					)
				)
	...
	public function render( $atts, $content = null ) {
		...
		$html = '<div ' . cocco_mikado_get_class_attribute( $holder_classes ) . ' ' . cocco_mikado_get_inline_attr( $holder_styles, 'style' ) . '>';
