...
class Process implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'            => esc_html__( 'Mikado Process', 'cocco-core' ),
					'base'            => $this->base,
					...
					'params'          => array(
						...
						array(
							...
							'value'       => array(
								esc_html__( '2 Columns', 'cocco-core' ) => 'two',
								esc_html__( '3 Columns', 'cocco-core' ) => 'three',
								esc_html__( '4 Columns', 'cocco-core' ) => 'four'
							),
							'save_always' => true
						),
						array(
							...
							'value'       => array(
								esc_html__( 'Default None', 'cocco-core' ) => '',
	...
	public function render( $atts, $content = null ) {
		...
		$html = cocco_core_get_shortcode_module_template_part( 'templates/process-template', 'process', '', $params );
