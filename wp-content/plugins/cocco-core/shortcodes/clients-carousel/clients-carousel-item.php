<?php
namespace CoccoCore\CPT\Shortcodes\ClientsCarouselItem;
...
class ClientsCarouselItem implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                    => esc_html__( 'Mikado Clients Carousel Item', 'cocco-core' ),
					'base'                    => $this->getBase(),
					...
					'params'                  => array(
						...
						array(
							...
							'heading'     => esc_html__( 'Hover Image', 'cocco-core' ),
							'description' => esc_html__( 'Select image from media library', 'cocco-core' )
						),
						array(
							'type'        => 'textfield',
						...
						array(
							'type'       => 'textfield',
							'param_name' => 'link',
							'heading'    => esc_html__( 'Custom Link', 'cocco-core' )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'target',
	...
	public function render( $atts, $content = null ) {
		...
		$html = cocco_core_get_shortcode_module_template_part( 'templates/clients-carousel-item', 'clients-carousel', '', $params );
