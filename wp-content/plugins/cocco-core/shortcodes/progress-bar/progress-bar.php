<?php
namespace CoccoCore\CPT\Shortcodes\ProgressBar;
...
class ProgressBar implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Mikado Progress Bar', 'cocco-core' ),
					'base'                      => $this->base,
					...
					'params'                    => array(
						...
						array(
							...
							'heading'    => esc_html__( 'Percentage Type', 'cocco-core' ),
							'value'      => array(
								esc_html__( 'Default', 'cocco-core' )  => '',
								esc_html__( 'Floating', 'cocco-core' ) => 'floating'
							),
						...
						array(
							...
							'heading'    => esc_html__( 'Active Color', 'cocco-core' )
						),
						array(
							'type'       => 'colorpicker',
							'param_name' => 'color_inactive',
							'heading'    => esc_html__( 'Inactive Color', 'cocco-core' )
						)
					)
				)
			);
	...
	public function render( $atts, $content = null ) {
		...
		$html = cocco_core_get_shortcode_module_template_part( 'templates/progress-bar-template', 'progress-bar', '', $params );
