<?php
namespace CoccoCore\CPT\Shortcodes\Banner;
...
class Banner implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Mikado Banner', 'cocco-core' ),
					'base'                      => $this->getBase(),
					...
					'params'                    => array(
						...
						array(
							...
							'heading'    => esc_html__( 'Image Overlay Color', 'cocco-core' )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'hover_behavior',
							'heading'     => esc_html__( 'Hover Behavior', 'cocco-core' ),
							'value'       => array(
								esc_html__( 'Visible on Hover', 'cocco-core' )   => 'mkdf-visible-on-hover',
								esc_html__( 'Visible on Default', 'cocco-core' ) => 'mkdf-visible-on-default',
								esc_html__( 'Disabled', 'cocco-core' )           => 'mkdf-disabled'
							),
							'save_always' => true
						),
						array(
						...
						array(
							...
							'heading'    => esc_html__( 'Content Border', 'equine-core' ),
							'value'       => array_flip( cocco_mikado_get_yes_no_select_array( true ) ),
						),
						array(
							'type'       => 'colorpicker',
						...
						array(
							...
							'heading'     => esc_html__( 'Info Position', 'cocco-core' ),
							'value'       => array(
								esc_html__( 'Default', 'cocco-core' )  => 'default',
								esc_html__( 'Centered', 'cocco-core' ) => 'centered'
							),
							'save_always' => true
						),
						array(
							...
							'heading'     => esc_html__( 'Info Content Padding', 'cocco-core' ),
							'description' => esc_html__( 'Please insert padding in format top right bottom left', 'cocco-core' )
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'subtitle',
						...
						array(
							...
							'heading'     => esc_html__( 'Words with Light Font Weight', 'cocco-core' ),
							'description' => esc_html__( 'Enter the positions of the words you would like to display in a "light" font weight. Separate the positions with commas (e.g. if you would like the first, third, and fourth word to have a light font weight, you would enter "1,3,4")', 'cocco-core' ),
							'dependency'  => array( 'element' => 'title', 'not_empty' => true )
						),
						array(
							'type'       => 'colorpicker',
						...
						array(
							...
							'heading'    => esc_html__( 'Link Text', 'cocco-core' ),
							'dependency' => array( 'element' => 'link', 'not_empty' => true )
						),
						array(
							'type'       => 'colorpicker',
							'param_name' => 'link_color',
							'heading'    => esc_html__( 'Link Text Color', 'cocco-core' ),
							'dependency' => array( 'element' => 'link', 'not_empty' => true )
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'link_top_margin',
							'heading'    => esc_html__( 'Link Text Top Margin (px)', 'cocco-core' ),
							'dependency' => array( 'element' => 'link', 'not_empty' => true )
						)
					)
				)
	...
	public function render( $atts, $content = null ) {
		...
		$html = cocco_core_get_shortcode_module_template_part( 'templates/banner', 'banner', '', $params );
	...
	private function getHolderClasses( $params, $args ) {
		...
		$holderClasses[] = ( $params['enable_border'] == 'yes') ? 'mkdf-banner-info-has-border': '';
	...
	private function getLinkStyles( $params ) {
		...
		if ( ! empty( $params['link_top_margin'] ) ) {
			$styles[] = 'margin-top: ' . cocco_mikado_filter_px( $params['link_top_margin'] ) . 'px';
		}
