<?php
if ( ! function_exists( 'cocco_mikado_init_google_fonts_array' ) ) {
	function cocco_mikado_init_google_fonts_array() {
		...
		$cocco_mikado_fonts_array = $google_fonts_decoded['items'];
	}
	add_action('after_setup_theme', 'cocco_mikado_init_google_fonts_array');
}